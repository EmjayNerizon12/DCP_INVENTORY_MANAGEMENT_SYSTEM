...
class SchoolDCPBatchController extends Controller
{
    ...
    public function editUpdateBatchStatus(Request $request, $batchId)
    {
        ...
        foreach ($batchItems as $item) {
            ...
            } elseif ($validated['type'] == 'certificate-completion') {
                if ($request->hasFile('file')) {
            ...
            } elseif ($validated['type'] == 'invoice-receipt') {
                if ($request->hasFile('file')) {
                    $item->update([
            ...
            } elseif ($validated['type'] == 'training-acceptance') {
                if ($request->hasFile('file')) {
                    $item->update([
