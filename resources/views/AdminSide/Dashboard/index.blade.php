		...
		<div class="rounded-lg overflow-hidden mb-2 py-2">
				<div class="grid md:grid-cols-4 grid-cols-2 gap-4">
						<a href="{{ route('index.schools') }}"
							...
							<span id="schools-card-arrow" class="absolute top-3 right-3 inline-flex h-9 w-9 items-center justify-center rounded-full bg-gray-200 animate-pulse">
							</span>
					...
					<!-- Total Batches -->
						<a href="{{ route('index.batch') }}"
							class="group relative bg-white shadow-md rounded-md border border-gray-300 p-5 flex flex-col justify-between transition-all duration-200 focus:outline-none">
							<span id="batches-card-arrow" class="absolute top-3 right-3 inline-flex h-9 w-9 items-center justify-center rounded-full bg-gray-200 animate-pulse">
							</span>
					...
					<!-- Total Items -->
						<a href="{{ route('index.dcp.items') }}"
							class="group relative bg-white shadow-md rounded-md border border-gray-300 p-5 flex flex-col justify-between transition-all duration-200 focus:outline-none">
							<span id="items-card-arrow" class="absolute top-3 right-3 inline-flex h-9 w-9 items-center justify-center rounded-full bg-gray-200 animate-pulse">
							</span>
						...
						<a href="{{ route('index.dcp.package') }}"
							class="group relative bg-white shadow-md rounded-md border border-gray-300 p-5 flex flex-col justify-between transition-all duration-200 focus:outline-none">
							<span id="packages-card-arrow" class="absolute top-3 right-3 inline-flex h-9 w-9 items-center justify-center rounded-full bg-gray-200 animate-pulse">
							</span>
