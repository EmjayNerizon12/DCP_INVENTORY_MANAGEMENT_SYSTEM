	    ...
	    <div class="p-2 md:my-5 mx-0 my-0">
	        ...
	        <div class="mb-4 rounded-md border border-gray-200 bg-white p-4 shadow-md">
	            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
	                ...
	                <div class="w-full md:w-auto flex md:justify-end justify-start">
	                    <select style="letter-spacing: 0.05rem" id="select-condition"
	                        class="px-3 py-2 text-md border border-gray-300 shadow-sm rounded-md bg-white md:min-w-[16rem]"
