	...
	@include('AdminSide.DCPBatch.Batch._editModal')
		...
		<div class="p-2">
			...
			<div class="mb-4 rounded-md border border-gray-200 bg-white p-4 shadow-md">
				<div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
					<div class="flex items-center gap-3">
						...
						<div>
							<div class="page-title">DCP Batch List</div>
							<div class="page-subtitle">Manage batch records, switch views, and add new deliveries.</div>
						</div>
					</div>
					...
					<div class="flex w-full flex-col gap-3 sm:flex-row lg:w-auto lg:items-center">
						<div class="w-full sm:w-44">
							...
							<select id="batchViewSelector" class="form-input w-full" onchange="toggleBatchView(this.value)">
								<option value="overview">Overview</option>
								<option value="table">Table</option>
							</select>
						</div>

						<button type="button" onclick="openCreateBatchModal()" class="btn-submit rounded px-4 py-1 whitespace-nowrap">
							Add Batch
						</button>
					</div>
				</div>
			...
			<div class="flex w-full sm:max-w-sm items-stretch my-2 ">
				<div class="bg-blue-600 flex items-center px-3 rounded-l py-1">
