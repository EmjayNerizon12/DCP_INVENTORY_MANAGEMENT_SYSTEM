...
@section('content')
	...
	<div class="md:p-6 p-2">
		...
		<div class="flex flex-col justify-center border border-gray-300 max-w-4xl bg-white p-2 w-full mx-auto">

			<div class="max-w-4xl w-full mx-auto shadow-md bg-white">
				...
				<div class="flex flex-row items-center justify-start gap-4 mx-2">
					<div class="relative group">
						...
						<div id="camera-button"
							...
							<button type="button" onclick="document.getElementById('schoolImageInput').click()"
								...
								<svg class="md:w-8 md:h-8 w-4 h-4" fill="currentColor" viewBox="0 -2 28 28" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="hidden">
				<div style="border:1px solid #ccc"
					...
					<div class="flex flex-col md:block hidden  items-center md:items-end justify-start my-4" style="min-width: 240px;">
